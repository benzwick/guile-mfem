...
;; TEST_MODE=full: all sample runs from ex0-lisp.scm header
;;
;; Sample runs from header:
;;   guile -L build ex0-lisp.scm
...
(define script (string-append project-root "/examples/ex0-lisp.scm"))
...
(define (run-example label args xfail?)
  "Run ex0-lisp with ARGS, check output files, print result with timing."
...
(format #t "~%=== ex0-lisp (TEST_MODE=~a) ===~%" test-mode)
