...
;; Test for examples/ex4.scm — Grad-div problem (MFEM Example 4)

(use-modules (srfi srfi-64) (test example-harness))

(define-values (run run/xfail) (make-example-runner "ex4.scm" '("sol.gf" "refined.mesh")))
