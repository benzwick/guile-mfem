...
;; Unit tests for VisItDataCollection parallel to serial format conversion
;; (from PyMFEM test/issues/test_3960.py).
...
(test-begin "mfem-par-datacollection")

;; Parallel VisItDataCollection to serial
(test-group "parallel-to-serial"
  (test-assert "placeholder" #t))

(define runner (test-runner-current))
(test-end "mfem-par-datacollection")
