...
;;               guile -L build ex2-lisp.scm -m ../data/beam-wedge.mesh
;;               guile -L build ex2-lisp.scm -m ../data/beam-quad.mesh -o 3 -s
;;               guile -L build ex2-lisp.scm -m ../data/beam-quad-nurbs.mesh
;;               guile -L build ex2-lisp.scm -m ../data/beam-hex-nurbs.mesh
;;
